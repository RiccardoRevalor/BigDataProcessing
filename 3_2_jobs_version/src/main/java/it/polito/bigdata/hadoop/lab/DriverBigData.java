...
public class DriverBigData extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		*/
		...
		//JOB 1: compute the number of occrrences of each pair of products
		...
		if (job.waitForCompletion(true) == true) {
			...
			//JOB2: compute the TOP-K algorithm with K = 100
			...
			// Set job input format
			job2.setInputFormatClass(KeyValueTextInputFormat.class); //A, B \t 3

			// Set job output format
			job2.setOutputFormatClass(TextOutputFormat.class); //top k list as string
			...
			numberOfReducersJob2 = 1; //1 because we use the TOP-K algorithm 
