 ...
 * Driver class.
 */
public class DriverBigData_Bonus extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(DriverBigData_Bonus.class);
		...
		// Set map class
		job.setMapperClass(MapperBigData_Bonus.class);
	...
	public static void main(String args[]) throws Exception {
		...
		int res = ToolRunner.run(new Configuration(), new DriverBigData_Bonus(), args);
